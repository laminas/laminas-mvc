...
- `HttpRouter`, mapping to `Laminas\Mvc\Service\HttpRouterFactory`. This grabs
...
See the [DB adapter documentation](https://getlaminas.org/manual/current/en/laminas.db.adapter.html)
for more configuration options.
